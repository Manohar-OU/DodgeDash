...
#include <vector>
#include <memory>
#include "GLViewDodgeDash.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewDodgeDash > glView( Aftr::GLViewDodgeDash::New( args) );
